...
I barely know about font programming.  Most codes are generated by AI agents.  You may find the generation prompt in *.cheatsheet.txt .  If the document is not present, check root/cheatsheet.txt , or I forgot to store the generation prompt.
